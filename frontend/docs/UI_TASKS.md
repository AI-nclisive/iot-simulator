...
- [x] `UI-101` Align RecordingRow and ReusableArtifact mock shapes to RecordingResponse
  ...
  Surfaces: Recordings page, Recording Export dialog, Replay Flow.
  Done when: both types contain only fields present in RecordingResponse; recordings page, export dialog, and replay flow work without removed fields; no TypeScript errors.
