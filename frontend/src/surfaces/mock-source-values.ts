...
const staticRows: SourceValueRow[] = [
  ...
  { id: "val-16", sourceId: "src-03", path: "pump[2].state", dataType: "string", currentValue: "Recording", updatedAt: "09:40:58", freshness: "Live", pinned: false },
...
const sampleValues: Record<SourceValueRow["dataType"], string[]> = {
  ...
  bool: ["true", "false"],
  string: ["Running", "Stopped", "Idle", "Error", "Clear", "Review", "Active"],
};
