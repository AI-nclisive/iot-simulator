...
- [ ] IS-198 [BE] ⬜ [schema] OptionSet (named bit flags) — correct capture/storage/replay of bit-set semantics; named-bit resolution during worker materialization; bit-flag struct encoding. Depends: IS-194. SPEC: Preserve OPC UA Type Fidelity
