...
- [ ] IS-176 [BE] ⬜ [schema] OPC UA address-space model — extend schemas with Objects, Methods, typed references, array dimensions and type definitions while preserving existing folders and variables. Validate inconsistent parents, missing reference targets and cyclic parent relationships. Depends: IS-175. — 01/04/05
