...
- [ ] IS-200 [BE] ✅ [schema] Manual OPC UA native schemas — synthetic source generation from native type structures; discovery and codification of vendor-specific catalogs via NodeSet import; complete fixture suite. Depends: IS-177. SPEC: Preserve OPC UA Type Fidelity / Manually Create Data Source Schemas
