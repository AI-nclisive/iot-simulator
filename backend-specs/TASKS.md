...
- [x] IS-117 [SDLC] ✅ Claude Code project skills for the contribution workflow (`/start-task`, `/open-pr`, `/review-loop`) under `.claude/skills/` — executable procedures for `CONTRIBUTING.md`/`AGENTS.md`
