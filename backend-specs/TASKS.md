...
- [ ] IS-197 [BE] 🟡 [schema] Abstract types (BaseDataType/Variant/UInteger) — capture and replay with native type discriminator preservation; test fixtures; integration tests. Depends: IS-194. SPEC: Preserve OPC UA Type Fidelity
