...
public record WorkerNetwork(String bindAddress, String advertisedHost, long scanTimeoutSeconds) {
    ...
    public WorkerNetwork(String bindAddress, String advertisedHost) {
        this(bindAddress, advertisedHost, WorkerClient.DEFAULT_SCAN_TIMEOUT_SECONDS);
    }
}
