...
public class AdminUserController {
    ...
    public record ChangeRoleRequest(@NotBlank @Pattern(regexp = "admin|user") String role) {}

    public record ChangeStatusRequest(@NotBlank @Pattern(regexp = "ACTIVE|SUSPENDED") String status) {}
}
