...
- data-source: simulated instrument source, for example OPC UA or Modbus TCP.
...
- fault: simulated unreliable condition, such as bad value, delay, disconnect, timeout, or unavailable data-source.
- evidence: exported artifact that shows what happened during a simulator run.
