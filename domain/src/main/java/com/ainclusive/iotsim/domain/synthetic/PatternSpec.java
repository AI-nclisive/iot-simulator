 ...
 * IS-200: {@code objectValue} (a Map) for structures, enums, unions, and OptionSets.
...
public record PatternSpec(
    ...
    public PatternSpec(String type, Double value, Double min, Double max, Long periodMs,
        ...
        this(type, value, min, max, periodMs, volatility, values, steps, stringValue,
                bytesValueBase64, dateTimeValue, null, null, null);
    }
    ...
    public PatternSpec(String type, Double value, Double min, Double max, Long periodMs,
            ...
            String bytesValueBase64) {
        this(type, value, min, max, periodMs, volatility, values, steps, stringValue,
                bytesValueBase64, null, null, null, null);
    }
    ...
    public PatternSpec(String type, Double value, Double min, Double max, Long periodMs,
        ...
        this(type, value, min, max, periodMs, volatility, values, steps, null, null, null, null, null, null);
    }
